...
void CopyBezierDashes(UIBezierPath *source, UIBezierPath *destination)
{
    ...
    CGFloat phase;
    CGFloat *pattern = (CGFloat *)malloc(count * sizeof(CGFloat));
...
UIBezierPath *BezierPathFromString(NSString *string, UIFont *font)
{
    ...
    // Create glyphs
    CGGlyph *glyphs = (CGGlyph *)malloc(sizeof(CGGlyph) * string.length);
...
- (void) addDashes: (NSArray *) pattern
{
    ...
    CGFloat *dashes = (CGFloat *)malloc(pattern.count * sizeof(CGFloat));
